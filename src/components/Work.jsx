  ...
  return (
    <div className='max-w-[1200px] mx-auto p-5' id='work'> 
        <div className='pb-8'>
            ...
            <p className='text-gray-400'> Some of my most recent projects</p>
        </div>

        <div className='grid sm:grid-cols-2 md:grid-cols-3 gap-4'>

            <div className='transform transition-transform duration-300 hove:scale-105 overflow-hidden
                            shadow-lg shadown-[#040c16] group container rounded-md flex justify-center items-center
